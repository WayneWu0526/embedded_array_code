...
_AK09973D_ROOT = os.path.join(os.path.dirname(__file__), "config", "ak09973d")


class AK09973DConfig(SensorArrayConfig):
    def __init__(self, config_root: str = _AK09973D_ROOT):
