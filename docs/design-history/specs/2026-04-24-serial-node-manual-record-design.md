...
**CSV File:** `{output_dir}/manual_record_{timestamp}.csv` (default: `~/embedded_array_ws/src/sensor_data_collection/data/`)
...
|-----------|------|---------|-------------|
| `~output_dir` | string | `~/embedded_array_ws/src/sensor_data_collection/data` | Directory for CSV output |
